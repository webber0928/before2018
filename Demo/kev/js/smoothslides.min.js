    ...
    $.fn.extend({
        smoothSlides: function(options) {
            ...
            function crossFade() {
                captionUpdater();
                paginateForwards();
                $('.ss-slide:last').addClass('notrans').fadeOut(500, function() {
            ...
            function zoomIn() {
                captionUpdater();
                paginateForwards();
                $('.ss-slide:last').addClass('notrans').fadeOut(5000, function() {
                    $(this).prependTo('.ss-slides').removeClass('notrans').css({
                        'webkitTransform': 'scale(1) rotate(0deg)',
                        'msTransform': 'scale(1) rotate(0deg)',
                        'transform': 'scale(1) rotate(0deg)'
            ...
            function panRight() {
                ...
                $('.ss-slide:last').addClass('notrans').fadeOut("slow", function() {
                    $(this).prependTo('.ss-slides').removeClass('notrans').css({
                        'webkitTransform': 'scale(1.3) rotate(0deg)',
                        'msTransform': 'scale(1.3) rotate(0deg)',
            ...
            if (options.autoPlay == 'false') {
                ...
                var fns = [zoomIn, panRight, panLeft];
            ...
            var fn = function() {
                if (options.effect == 'random' && options.autoPlay == 'true') {
                    var fns = [panRight, panLeft, panUp, panDown];
                    fns[Math.floor(Math.random() * fns.length)]();
                } else if (options.effect == 'false') {
                    //
                } else {
            ...
            $(document.body).on('click', '.ss-paginate a', function(event) {
                ...
                if ($('.ss-slide:last').attr('title')) {
                    var caption = $('.ss-slide:last').attr('title');
                    $('.ss-caption').html(caption).fadeIn(100);
                } else {
                    $('.ss-caption').fadeOut(100, function() {
                        $('.ss-caption').empty();
                    });
                }
                event.preventDefault();
